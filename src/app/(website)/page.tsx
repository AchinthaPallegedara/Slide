          ...
          <div className="container px-4 py-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="h-8 w-8 rounded-lg bg-white dark:bg-black flex items-center justify-center font-bold">
                  li
                </div>
              ...
              <Button className="bg-white text-primary dark:bg-black dark:text-white dark:ring-primary dark:ring-2">
